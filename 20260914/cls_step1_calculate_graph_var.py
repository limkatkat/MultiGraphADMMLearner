...
from learn_graph_utility import PrepareLogDegreeVarianceGraphLearner, SingleGraphLearnerWrapper
...
def process_graphs_by_ratio(
    ...
    for ent_strength in l2_strengths:
        all_jobs = []
        ...
        learner_maker = PrepareLogDegreeVarianceGraphLearner(ent_strength)
...
def main():
    ...
    mask_folders = ['bna']
    var_strengths = [0.002*i for i in range(1, 5)] + [0.02*i for i in range(1, 5)] + [0.2*i for i in range(1, 5)]
