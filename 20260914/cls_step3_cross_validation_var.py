...
if __name__ == '__main__':
    ...
    for reg_strength in reg_strengths:
        ...
        reg_output_dir = output_dir / reg_str
        reg_output_dir.mkdir(exist_ok=True)
                
        for yeo_nets, test_params in zip(YEO_NETWORK_COUNTS, test_param_list):
            ...
            for feature_type in FEATURE_TYPES:
                ...
                for edge_ratio in edge_ratios:
                    print("\n" + "="*60)
                    print(f" Loading Data: Edge Ratio = {edge_ratio}, Entropy = {reg_str}, Feature Type = {feature_type}")
                    print("="*60)
                    
                    # Load Data
                    feat_file_path = data_dir / reg_str / f'Yeo{yeo_nets}-{edge_ratio:.02f}.csv'
