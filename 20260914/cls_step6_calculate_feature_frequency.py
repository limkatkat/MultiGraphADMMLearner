...
CONFIG = {
    ...
    # Options: 'max_div_std', 'max_div_std_all', 'max', 'std', etc.
...
baseline = Path(f'graphs-{CONFIG['model']}')
STABILITY_THRESHOLD = '0.9'
result_root = baseline / 'FunImgARglobalCWSF' / f'bna-feat-out-{STABILITY_THRESHOLD}'
data_dir = baseline / 'FunImgARglobalCWSF' / 'bna-feat'
...
def get_feature_names(feature_type_config, df_header):
    ...
    if isinstance(feature_type_config, tuple):
        ...
        # String type: covers basic features AND pre-computed max_div_std
